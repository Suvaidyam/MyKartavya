    ...
    <div class="px-3">
      ...
      <div class="grid grid-cols-2 gap-4 pt-3">
        ...
        <div class="border border-gray-300 rounded-lg px-4 py-3 text-center">
          ...
          <p class="text-lg font-semibold text-[#0B0B0B]">{{ activities.total_hours || "0" }} hrs</p>
        </div>
        ...
        <div class="border border-gray-300 rounded-lg px-4 py-3 text-center">
          ...
          <p class="text-lg font-semibold text-[#0B0B0B]">₹ {{ activities.work_value_rupees || "0" }}</p>
        </div>
      </div>
    </div>
      ...
      <div class="rounded-t-xl px-6 py-4 relative overflow-hidden bg-gradient-to-b from-yellow-200 to-white">
        ...
        <div class="flex flex-col items-center">
          ...
          <p class="text-sm font-medium pt-3 ">
            {{ activitiestopuser[0]?.first_name || "Top 1" }}</p>
        ...
        <div class="flex justify-between -mt-10">
          ...
          <div class="flex flex-col items-center">
            ...
            <p class="text-xs font-medium pt-3 ">
              {{ activitiestopuser[1]?.first_name || "Top 1" }}</p>
            <p class="text-[10px] font-normal pt-2 flex gap-1">
              <FeatherIcon name="database" class="size-3 text-[#666666]" />
          ...
          <div class="flex flex-col items-center">
            ...
            <p class="text-xs font-medium pt-3">
              {{ activitiestopuser[2]?.first_name || "Top 1" }}</p>
            <p class="text-[10px] font-normal pt-2 flex gap-1">
              <FeatherIcon name="database" class="size-3 text-[#666666]" />
