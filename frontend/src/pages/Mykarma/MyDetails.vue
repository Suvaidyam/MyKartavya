  ...
  <aside class="w-full xl:w-1/4 bg-white rounded-md pt-3 lg:mt-0">
    <div class="px-3">
      ...
      <div class="border-b">
        ...
        <p class="text-[47px] font-semibold text-red-500">{{activities.karma_points || "0 "}}</p>
      </div>
      ...
      <div class="grid grid-cols-2 gap-4 pt-3">
        ...
        <div class="border border-gray-300 rounded-lg px-4 py-3 text-center">
          ...
          <p class="text-lg text-black">{{activities.total_hours}} hrs</p>
        </div>
      ...
      >
        ...
        <div class="flex flex-col items-center">
          <div class="relative">
            ...
            >
              <img v-if="activitiestopuser[0]?.user_image"
          ...
          <p class="text-xs font-medium pt-2">{{ activitiestopuser[0]?.first_name ||"Top 1" }}</p>
          <p class="text-[10px] font-normal pt-2">{{ activitiestopuser[0]?.total_karma_points|| "0" }} Points {{ activitiestopuser[0]?.total_hours || "0" }} hr</p>
        </div>
        ...
        <div class="flex justify-between -mt-10">
          ...
          <div class="flex flex-col items-center">
            <div class="relative">
              ...
              >
              <img v-if="activitiestopuser[1]?.user_image"
             ...
             <p class="text-xs font-medium pt-2">{{ activitiestopuser[1]?.first_name ||"Top 2" }}</p>

            <p class="text-[10px] font-normal pt-2">{{ activitiestopuser[1]?.total_karma_points|| "0" }} Points {{ activitiestopuser[1]?.total_hours || "0" }} hr</p>
          </div>
          ...
          <div class="flex flex-col items-center">
            <div class="relative">
              ...
              >
              <img v-if="activitiestopuser[2]?.user_image"
             ...
             <p class="text-xs font-medium pt-2">{{ activitiestopuser[2]?.first_name||"Top 3" }}</p>
            <p class="text-[10px] font-normal pt-2">{{ activitiestopuser[2]?.total_karma_points || "0" }} Points {{ activitiestopuser[2]?.total_hours || "0" }} hr</p>
          </div>
        </div>
      </div>
      ...
      <table class="w-full">
        ...
        <tbody v-if="users.length > 0">
          ...
          >
            ...
            <td class="text-[10px] font-normal text-center">{{ user?.karma_points }}</td>
            <td class="text-[10px] font-normal text-center">{{ user?.rank }}</td>
          </tr>
        </tbody>
        <tbody v-else>
          <tr>
...
const topvolunteer = async () => {
  try {
    const response = await call('mykartavya.controllers.api.top_three_volunteer');
    if (response ) {
