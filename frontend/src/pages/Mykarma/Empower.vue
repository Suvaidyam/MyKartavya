      ...
      <div class="p-6 md:p-10 bg-gray-100">
        ...
        <div class="grid gap-6 lg:grid-cols-3">
          ...
          <div class="lg:col-span-2">
            <p
              class="mb-4 text-bodyh2 font-normal text-justify"
              style="color: #666666"
            >
            ...
            <p
              class="mt-2 text-bodyh2 font-normal text-justify"
              style="color: #666666"
            >
            ...
            <div class="mt-4">
              <p
                class="text-[14px] font-poppins font-normal leading-[23.8px] tracking-[0.0025em] text-[#666666] text-justify"
              ...
              >
                ...
                <span class="text-secondary hover:cursor-pointer"
                  >@MyKaratvaya @NASSCOMfdn</span
                >
              </p>
            ...
            <div
              class="flex items-center gap-[12px] flex-col justify-self-start mt-[220px]"
            >
              <span
        ...
        <div class="mt-10">
          <div class="flex justify-between">
            ...
            <div class="flex gap-3">
              <i
                class="fa-solid fa-less-than w-[7px] h-[12px] text-[#999999]"
              ></i>
              <i
                class="fa-solid fa-greater-than w-[7px] h-[12px] text-[#0B0B0B]"
              ></i>
            </div>
          </div>
          <div
