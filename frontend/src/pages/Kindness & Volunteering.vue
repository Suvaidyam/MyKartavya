<template>
    <div class=" h-screen w-full">
        ...
        <section>
            ...
            <div
                class="absolute left-8 top-48  max-w-sm w-[448px] h-[312px] bg-white shadow-lg rounded-lg p-4 border border-gray-200 flex flex-col gap-4 justify-center">
                <div class="border-b pb-2">
                    <div class="text-gray-500 text-caption font-normal ">My Karma / Kindness & Volunteering / Empower
                        the needy
                    </div>
            ...
            <div class="p-6 md:p-10 bg-gray-100 ">
                ...
                <div class=" grid gap-6 lg:grid-cols-3">
                    ...
                    <div class="lg:col-span-2   ">
                        ...
                        <div class="mt-4">
                            <p class="text-bodyh2 font-normal font-poppins "
                                style="  word-spacing: 28px; letter-spacing: 0.25%; color: #666666;">Share your
                                experience along with
                                pictures on
                                your social media handles and tag us on social media using <span
                                    class="text-secondary"> @MyKaratvaya @NASSCOMfdn</span></p>
                            <!-- <p class="text-gray-600">@MyKartavya @NASSCOMfdn</p> -->
                            <p class="mt-2 text-bodyh2 font-normal font-poppins" style="color: #666666;">Use hashtag
                                #MyKartavya #DoGoodFeelGood #LittleActMatters #womenempowerment#letsgrowtogether
                            </p>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="">
                            ...
                            <span class="text-gray-700 font-medium flex items-center space-x-2">
                                ...
                                <span class="text-bodyh1 font-medium font-poppins" style="color: #0B0B0B;">Share
                                    activity with others</span>
                            </span>
                            <div class="flex gap-3">
                                <button v-for="icon in icons" :key="icon.name" :aria-label="icon.name"
                                    class="p-2 bg-white rounded-full hover:bg-gray-300">
                                    <component :is="icon.svg" class="w-5 h-5 text-gray-600" />
                                </button>
                            </div>
                        </div>
                            <h2 class="text-heading4 pt-4 font-medium font-poppins" style="color: #0B0B0B;">Related
                                Opportunities</h2>
                            <div class="mt-4 grid grid-cols-1 gap-3 justify-center ">
                                <div class=" bg-white rounded-lg shadow-lg overflow-hidden">
                                    ...
                                    <div class="p-4">
                                        <h3 class="text-bodyh1 font-medium " style="color: #0B0B0B;">Empower the needy
                                        </h3>
                                        <p class=" text-caption font-normal mt-1 font-poppins" style="color: #666666;">
                                            This Women’s Entrepreneurship Day, let’s empower underserved women running
                                            small
                                            business...
                                        </p>
                                        <div class="flex items-center text-sm text-gray-500 mt-3">
                                            <span class="flex items-center text-caption font-normal"
                                                style="color: #0B0B0B;">
                                                <p><i class="far fa-calendar-alt mr-1"
                                                        style="color: #666666 !important;"></i></p> 01 Oct,
                                                2024 - 30 Nov, 2024
                                            </span>
                                            <p class="ml-auto flex items-center text-caption font-normal"
                                                style="color: #0B0B0B;"> <span><i class="far fa-clock mr-1"
                                                        style="color: #666666 !important; "></i></span>50 hr</p>
                                        </div>
                                        <div class="flex items-center mt-3">
                                            ...
                                            <button class="ml-auto text-orange-600 font-semibold text-sm">ACT NOW
                                                →</button>
                                        </div>
                                    </div>
                                </div>
