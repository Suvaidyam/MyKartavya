    ...
    <div class="max-w-[1920px] mx-auto">
            ...
            <div class="w-full pb-8 md:pb-16">
              <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
                <div class="lg:col-span-8">
                  <div
                    ...
                    <div class="flex flex-wrap items-center gap-3 mb-4 lg:mb-6">
                      ...
                      <span class="flex items-center gap-2 text-base lg:text-xl text-white">
                        <svg width="20" height="18" class="lg:w-6 lg:h-6" viewBox="0 0 16 14" fill="none"
                    ...
                    <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 lg:mb-6 leading-tight">
                    ...
                    <div class="flex flex-wrap items-center gap-3 mb-4 lg:mb-6">
                      <div v-if="selectedOpportunity?.sdgs" v-for="item in JSON.parse(selectedOpportunity?.sdgs)"
                        ...
                        <img v-if="item?.image" :src="item.image" class="w-8 h-8 lg:w-10 lg:h-10" />
                        <span v-else
                    ...
                    <div
                      ...
                      <div class="w-full lg:flex-1">
                        <div class="w-full bg-white/30 rounded-full h-2 lg:h-3 overflow-hidden">
                          <div
                            class="bg-gradient-to-r from-green-400 to-green-500 h-2 lg:h-3 rounded-full transition-all duration-500"
                        ...
                        <div class="flex items-center justify-between mt-2 text-sm lg:text-xl">
                          ...
                          <span>{{ selectedOpportunity?.donet_hours ? ((selectedOpportunity?.donet_hours / 60) /
                ...
                <div class="lg:col-span-4">
                  <div
                    class="bg-white/10 backdrop-blur-lg rounded-2xl lg:rounded-3xl p-6 lg:p-8 border border-white/20 shadow-xl">
                    <h3 class="text-xl lg:text-2xl font-semibold text-white mb-4 lg:mb-6">Share Opportunity</h3>
      ...
      <div class="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <div class="lg:col-span-8">
            <div
              class="bg-white rounded-2xl lg:rounded-3xl shadow-xl p-6 lg:p-12 mb-8 lg:mb-12 min-h-[600px] lg:min-h-[800px] transform hover:shadow-2xl transition-all duration-300">
              <h2 class="text-2xl lg:text-4xl font-bold mb-6 lg:mb-10 text-gray-800">About the Opportunity</h2>
          ...
          <div class="lg:col-span-4">
            <div
              class="bg-white rounded-2xl lg:rounded-3xl shadow-xl p-6 lg:p-12 sticky top-4 lg:top-8 transform hover:shadow-2xl transition-all duration-300">
              <h2 class="text-2xl lg:text-4xl font-bold mb-4 lg:mb-8 text-gray-800">Activity Timeline</h2>
        ...
        <div class="mt-12 lg:mt-24">
          ...
          <div ref="scrollContainer" class="relative">
            <div v-if="Opportunities?.length > 0" class="flex gap-4 lg:gap-8 pb-4 overflow-x-auto scrollbar-hide">
