<template>
  <div class="h-screen w-full">
    ...
    <section>
      <div
        class="w-full h-[456px] md:h-[456px] back-img flex items-center mt-10 px-4 md:px-20"
      >
        <div
        ...
        >
          ...
          <div class="flex items-center" style="color: #666666">
            ...
            <span
              class="flex items-center text-bodyh2 font-normal mr-4"
              style="color: #0b0b0b"
            >
          ...
          <div
            class="flex items-center text-gray-600 text-bodyh2 font-normal justify-between border-b pb-2"
          >
            <span
          ...
          <div class="">
            <div class="w-full bg-gray-200 rounded-full h-[5px]">
              <div
                class="bg-green-500 h-[5px] rounded-full"
                style="width: 60%"
              ></div>
            </div>
        ...
        <!-- <img
          src="https://s3-alpha-sig.figma.com/img/5fe6/fe04/058446e1c3ea035d2efd21a222ccb475?Expires=1740960000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=P-8K1XloauUtT7UVndu4L199Efq0NENaBmmYHpVZpgONi2Uxpbz6sP03gkJBPdo4LkhBZ1fbOgLHSF5Eq3RNvLCuSsdvhVTynPV2e7NlZ9TZqQFww3WueaAI-fXncdfG4xbhgvymccrF-Z0mLImqTne-4fbkk7I4tpHnChzjvmrENAMzsmMxFnhphfuatDa7~5RIlmLt84tmjiz2IBgoSZ3ZhV4WoGL7DQWE6OvV3uJ7JjoFHdUr9mNkWYKbcOJ~q0ehkwRR8XCYap4lG-BdlaOmQdG6ro1QlcixF~YEzhnDfvP1M4Gk00B~4lHnip9Hbzqkwml0NoehBoFPs-zkRQ__"
    ...
    <section class="w-full bg-gray-700">
      <div class="p-6 md:p-10 bg-gray-100">
        ...
        <div class="grid gap-6 lg:grid-cols-3">
          ...
          <div class="lg:col-span-2">
            <p class="mb-4 text-bodyh2 font-normal" style="color: #666666">
              <span class="text-[40px] text-black">T</span>his Women’s
            ...
            <div class="mt-4">
              <p
                class="text-bodyh2 font-normal font-poppins"
                style="
                  word-spacing: 28px;
                  letter-spacing: 0.25%;
                  color: #666666;
              ...
              <p
                class="mt-2 text-bodyh2 font-normal font-poppins"
                style="color: #666666"
              >
            ...
            <div
              class="flex items-center space-x-4 flex-col justify-self-start mt-24"
            >
              <span
                class="text-gray-700 font-medium flex items-center space-x-2"
              >
                <Share2 class="w-5 h-5 text-gray-600" />
                <span
                  class="text-bodyh1 font-medium font-poppins"
                  style="color: #0b0b0b"
                  >Share activity with others</span
                >
              </span>
        ...
        <div class="mt-10">
          <h2
            class="text-heading4 font-medium font-poppins"
            style="color: #0b0b0b"
          >
            Related Opportunities
          </h2>
          ...
          >
              ...
              <div class="relative">
                ...
                >
                  <span class="bg-white text-black px-2 py-1 rounded text-xs"
                    >SDG 10 : Reduced Inequalities</span
                  >
                </div>
              </div>
              <div class="p-4">
                ...
                <p
                  ...
                  style="color: #666666"
                >
                  This Women’s Entrepreneurship Day, let’s empower underserved
                  women running small business...
                </p>
                <div class="flex items-center text-sm text-gray-500 mt-3">
                  <span
                    class="flex items-center text-caption font-normal"
                    style="color: #0b0b0b"
                    ><p>
                      <i
                    ...
                    01 Oct, 2024 - 30 Nov, 2024</span
                  >
                  <p
                    class="ml-auto flex items-center text-caption font-normal"
                    style="color: #0b0b0b"
                  >
                    <span
                      ><i
                ...
                <div class="flex items-center mt-3">
                  ...
                  <button class="ml-auto text-orange-600 font-semibold text-sm">
                    ACT NOW →
                  </button>
                </div>
              </div>
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
              <div class="relative">
                <img
                  src="https://s3-alpha-sig.figma.com/img/4eef/bb3e/cb7e638434524a3fd3e9120880f4b9fe?Expires=1740960000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=HwfLpSHiSVsMn66x9wvOo7BzqaiJTMqiCXYE4iX6OZRxbGnsOOjDHT1xbXHQ8MGlWrapbOLLAJT4hPBAqtzqpmw~4pEA79VY1IRA4LBryMZuR~jzsZuF2gnKgKDZo06cKb14LKJ~YxaLbBbYME8qKc5AhBK8U6PceEklz7Flfgr2Q5ihmTKS5RFGImqVvd0O648b7Ajd5DaxAAmiZXKtlb8jFHRrpsyJ8~qyPLvnVqBh3OwySpBNL7WiRUtkaJIMNRGN6YCi~3QpupbFYfmiT6i8n4ME1gzkU3zSC9o3jjQzXVS-KuofZkXgG8UbRNzBzkR3Srz6AzFz1Fv4drkr~g__"
                  alt="Children"
                  class="object-cover"
                />
                <div
