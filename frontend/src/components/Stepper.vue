        ...
        <div class="relative border-gray-300 pl-3">
          <div v-for="(step, index) in steps" :key="index" class="mb-6 relative border-l">
            ...
            <div :class="index > currentStep
              ...
              : ''
              ">
              <p class="text-[10px] font-normal px-6" :class="index === steps.length - 1 ? 'text-[#FF5722]' : 'text-[#999999]'">
                STEP {{ index + 1 }}
              </p>
              ...
              <button
                ...
                class="mt-3 h-[28px] w-[147px] rounded-sm text-caption font-medium text-white ml-6" :class="index === steps.length - 1 ? 'bg-orange-500' : 'bg-orange-500'
                  ">
                {{ step.button }}
              </button>
              <button disabled
                ...
                @click="nextStep(index)"
                class="mt-3 h-[28px] cursor-not-allowed w-[147px] rounded-sm text-caption font-medium text-white ml-6"
