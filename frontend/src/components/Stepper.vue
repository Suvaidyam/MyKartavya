          ...
          >
            ...
            >
              ...
              <button
                ...
                :class="
                  index === steps.length - 1 ? 'bg-orange-500' : 'bg-orange-500'
                "
              >
                {{ step.button }}
              </button>
        ...
        >
          <div class="bg-white rounded-lg shadow-lg p-6 w-[500px]">
            <div class="flex justify-between items-center border-b pb-2 mb-4">
              ...
              <button
                @click="activityReportPopup = false"
            ...
            <div class="mb-4">
              <label class="block font-medium mb-1"
                >How much time you donated while working on the activity?</label
              >
            ...
            <div class="mb-4">
              <label class="block font-medium mb-1"
                >How much percent work has completed?</label
              >
            ...
            <div class="mb-4">
              ...
              <div
                class="border-dashed border-2 border-gray-300 p-6 rounded-lg text-center relative"
              >
                <input
                  type="file"
                  multiple
                ...
                <div class="flex flex-col items-center text-gray-500">
                  ...
                  >
                    <path
                      ...
                      d="M12 16.5V3m0 0l-3.5 3.5M12 3l3.5 3.5"
                    />
                    <path
                      stroke-linecap="round"
                      stroke-linejoin="round"
