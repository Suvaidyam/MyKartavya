        ...
        <div class="bg-white rounded-lg">
            <div class="bg-white p-6 rounded-lg w-full relative">
                ...
                <div class="relative border-gray-300 pl-3">
                    <div v-for="(step, index) in steps" :key="index" class="mb-6 relative">
                        ...
                        <div class="absolute left-0 top-0 h-full w-[1px]" :class="[
                            ...
                            !step.completed && index > currentStep ? 'blur-sm opacity-50' : ''
                        ]">
                        </div>
                        ...
                        <div class="absolute -left-4 w-7 h-7 min-w-7 max-h-7 rounded-full flex items-center justify-center"
                            ...
                            <div v-else>
                                ...
                                <div v-if="step.title == 'Activity Approval'"
                                    class="w-4 h-4 flex items-center justify-center">
                                    <img src="../assets/Frame (3).png" alt="" class="w-4 h-4" />
                                </div>
                                <div v-if="step.title == 'Get Started'"
                                    class="w-4 h-4 flex items-center justify-center">
                                ...
                                <!-- Feedback Icon -->
                                <div v-if="step.title == 'Submit Feedback'"
                                    class="w-4 h-4 flex items-center justify-center">
                                    <svg width="19" height="19" viewBox="0 0 19 19" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        <!-- Step content - FIX: Removed blur and opacity from completed steps -->
                        <div :class="[
                            step.completed ? 'relative' :
                                (index > currentStep ? 'blur-sm opacity-50 pointer-events-auto relative' : 'relative')
                        ]" @click="!step.completed && index > currentStep && (showLockedStepPopup = true)">
                            ...
                            <div v-if="index == 0">
                                ...
                                <button v-else-if="props.activity.workflow_state == 'Applied'"
                                    class="mt-3 h-[28px] uppercase cursor-not-allowed px-3 rounded-sm text-caption font-medium text-white ml-6 bg-gray-400 button-animation">
                                    Pending by Admin
                                </button>
                            </div>

                            <div v-if="index == 1">
                                <button v-if="!step.completed && activity.workflow_state == 'Approved'"
                                    @click="nextStep(index)"
                                    class="mt-3 h-[28px] px-3 uppercase rounded-sm text-caption font-medium text-white ml-6 bg-[#FF5722] button-animation">
                                    {{ step.button }}
                                </button>
                ...
                <div v-if="showLockedStepPopup" class="fixed inset-0 flex items-center justify-center z-[100]">
                    ...
                    <div
                        class="bg-white rounded-lg p-4 relative z-[101] flex items-center gap-3 shadow-lg max-w-md mx-4">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex justify-center gap-6 my-3">
                                <button v-for="(emoji, index) in emojis" :key="index"
                                    @click="feedback.rating = emoji.label"
                ...
                <div v-if="showKarmaPopup"
                    ...
                    <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6 text-center">
                        <div class="mb-6">
                            ...
                            <p class="text-gray-600">You've earned {{ activity.karma_points }} karma points</p>
                        </div>
                        <div class="flex justify-center">
                            <button v-if="activity.need_certificate == 'Yes'" @click="viewCertificate"
