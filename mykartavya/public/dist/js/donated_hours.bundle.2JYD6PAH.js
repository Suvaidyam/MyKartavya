...
Only state can be modified.`);
  ...
  var _hoisted_1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h1", null, "Hyy Aniket", -1));
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock(Fragment, null, [
      createCommentVNode(" HTML template "),
      _hoisted_1
    ], 2112);
  }
...
* @license MIT
**/
//# sourceMappingURL=donated_hours.bundle.2JYD6PAH.js.map
