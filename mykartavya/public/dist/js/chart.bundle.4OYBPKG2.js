...
Only state can be modified.`);
  ...
  // sfc-template:/workspace/development/frappe_docker/frappe-bench/apps/mykartavya/mykartavya/public/js/Chart/chart.vue?type=template
  var _hoisted_1 = { class: "chart-container" };
  var _hoisted_2 = { class: "chart-header" };
  var _hoisted_3 = /* @__PURE__ */ createBaseVNode("canvas", { id: "myChart" }, [
    /* @__PURE__ */ createCommentVNode(" Chart.js will render the chart here ")
  ], -1);
  function render(_ctx, _cache) {
    return openBlock(), createElementBlock("div", _hoisted_1, [
      createBaseVNode("div", _hoisted_2, [
        createBaseVNode("h2", null, toDisplayString(_ctx.chartTitle), 1),
        createBaseVNode("button", {
          onClick: _cache[0] || (_cache[0] = (...args) => _ctx.refreshChart && _ctx.refreshChart(...args))
        }, "Refresh")
      ]),
      _hoisted_3
    ]);
  ...
  // ../mykartavya/mykartavya/public/js/Chart/chart.vue
  var script = {};
  script.render = render;
  script.__file = "../mykartavya/mykartavya/public/js/Chart/chart.vue";
  var chart_default = script;

  // ../mykartavya/mykartavya/public/js/Chart/chart.bundle.js
  var Charts = class {
    constructor({ wrapper }) {
    ...
    setup_app() {
      ...
      this.app = createApp(chart_default);
  ...
  var chart_bundle_default = Charts;
})();
/*!
 * pinia v3.0.2
...
* @license MIT
**/
//# sourceMappingURL=chart.bundle.4OYBPKG2.js.map
