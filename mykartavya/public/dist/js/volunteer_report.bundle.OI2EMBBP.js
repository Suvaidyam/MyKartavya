...
Only state can be modified.`);
    ...
    setup(__props, { expose: __expose }) {
      ...
      function rejectActivity(doc2) {
        ...
        frappe.confirm(
          ...
          () => {
            frappe.db.set_value("Volunteer Activity", doc2.name, "completion_wf_state", "Rejected").then(() => {
              frappe.msgprint("Activity marked as Rejected.");
              const updated = volunteers.value.find((v) => v.name === doc2.name);
              if (updated)
                updated.completion_wf_state = "Rejected";
            }).catch((err) => {
  ...
  var _hoisted_7 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("path", { d: "M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16" }, null, -1));
  var _hoisted_8 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("path", { d: "M3 21v-5h5" }, null, -1));
  var _hoisted_9 = [
    _hoisted_5,
    _hoisted_6,
    _hoisted_7,
  ...
  var _hoisted_10 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("svg", {
    class: "btn-icon",
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
  ...
  var _hoisted_11 = { class: "table-wrapper" };
  var _hoisted_12 = { class: "report-table" };
  var _hoisted_13 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("thead", null, [
    /* @__PURE__ */ createBaseVNode("tr", null, [
      /* @__PURE__ */ createBaseVNode("th", null, "#"),
      /* @__PURE__ */ createBaseVNode("th", null, "Volunteer"),
      /* @__PURE__ */ createBaseVNode("th", null, "Duration"),
      /* @__PURE__ */ createBaseVNode("th", null, "Completion Status"),
  ...
  var _hoisted_19 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("td", {
    colspan: "8",
    class: "empty-msg-cell"
  }, [
    /* @__PURE__ */ createBaseVNode("div", { class: "empty-msg-wrapper" }, [
      ...
      /* @__PURE__ */ createBaseVNode("span", { class: "empty-text" }, "No records found.")
    ])
  ], -1));
  var _hoisted_20 = [
    _hoisted_19
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("div", _hoisted_1, [
      createCommentVNode(" Export Button "),
        ...
        createBaseVNode("div", _hoisted_4, [
          createBaseVNode("button", {
            ...
            (openBlock(), createElementBlock("svg", {
              class: normalizeClass(["btn-icon transition-transform duration-500", { "rotate-180": $setup.rotated }]),
              viewBox: "0 0 24 24",
              fill: "none",
              stroke: "currentColor",
              "stroke-width": "2"
      ...
      createBaseVNode("div", _hoisted_11, [
        createBaseVNode("table", _hoisted_12, [
          ...
          createBaseVNode("tbody", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList($setup.volunteers, (volunteer, index) => {
              return openBlock(), createElementBlock("tr", {
                key: (volunteer == null ? void 0 : volunteer.name) || index
              }, [
                createBaseVNode("td", {
                ...
                createBaseVNode("td", null, [
                  createBaseVNode("span", {
                    class: normalizeClass($setup.getStatusClass(volunteer == null ? void 0 : volunteer.completion_wf_state))
                  }, toDisplayString(volunteer == null ? void 0 : volunteer.completion_wf_state), 3)
                ]),
                createBaseVNode("td", null, toDisplayString(volunteer == null ? void 0 : volunteer.karma_points) + " Pts", 1),
                createBaseVNode("td", null, toDisplayString(volunteer == null ? void 0 : volunteer.rating), 1),
                createBaseVNode("td", null, [
                  createBaseVNode("i", _hoisted_15, toDisplayString(volunteer == null ? void 0 : volunteer.com_percent) + "%", 1)
                ]),
                createBaseVNode("td", _hoisted_16, [
                  createBaseVNode("button", {
                    class: "reject-btn btn btn-danger",
                    onClick: ($event) => $setup.rejectActivity({ name: volunteer == null ? void 0 : volunteer.name }),
                    disabled: (volunteer == null ? void 0 : volunteer.completion_wf_state) === "Rejected"
                  }, " Reject ", 8, _hoisted_17)
                ])
              ]);
            }), 128)),
            $setup.volunteers.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_18, [..._hoisted_20])) : createCommentVNode("v-if", true)
          ])
        ])
      ])
    ]);
  ...
  // ../mykartavya/mykartavya/public/js/Activity_vol_Report/volunteer_report.vue
  volunteer_report_default.render = render;
  volunteer_report_default.__file = "../mykartavya/mykartavya/public/js/Activity_vol_Report/volunteer_report.vue";
  volunteer_report_default.__scopeId = "data-v-faa77af5";
  var volunteer_report_default2 = volunteer_report_default;

  // ../mykartavya/mykartavya/public/js/Activity_vol_Report/volunteer_report.bundle.js
  var ActVolReport = class {
    constructor({ wrapper }) {
    ...
    setup_app() {
      ...
      this.app = createApp(volunteer_report_default2);
  ...
  frappe.ui.ActVolReport = ActVolReport;
...
* @license MIT
**/
//# sourceMappingURL=volunteer_report.bundle.OI2EMBBP.js.map
