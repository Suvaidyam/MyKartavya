frappe.dom.set_style("/* sfc-style:/workspace/development/frappe_docker/frappe-bench/apps/mykartavya/mykartavya/public/js/Activity_vol_Report/Ngo_page/ngo.vue?type=style&index=0 */\n.container[data-v-2f2682a3] {\n  padding: 20px;\n  max-width: 800px;\n  margin: 0 auto;\n}\nh1[data-v-2f2682a3] {\n  color: #333;\n  margin-bottom: 20px;\n}\np[data-v-2f2682a3] {\n  font-size: 16px;\n  line-height: 1.6;\n  color: #666;\n}\n/*# sourceMappingURL=ngo_page.bundle.7KQ76OK5.css.map */\n");
(() => {
...
`], ...formatTraceEntry2(entry));
  ...
  // sfc-script:/workspace/development/frappe_docker/frappe-bench/apps/mykartavya/mykartavya/public/js/Activity_vol_Report/Ngo_page/ngo.vue?type=script
  var ngo_default = {
    __name: "ngo",
    setup(__props, { expose: __expose }) {
      ...
      const stateName = ref("");
      const stateId = ((_a25 = route == null ? void 0 : route.params) == null ? void 0 : _a25.name) || null;
      onMounted(() => {
        if (!stateId) {
          console.error("No state ID found in route params");
          loading.value = false;
          return;
        }
        ...
        frappe.call({
          ...
          callback: function(res) {
            loading.value = false;
            if (res.message && res.message.state_name) {
              stateName.value = res.message.state_name;
            } else {
      ...
      const __returned__ = { route, loading, stateName, stateId, ref, onMounted, get useRoute() {
        return useRoute;
      } };
  ...
  // sfc-template:/workspace/development/frappe_docker/frappe-bench/apps/mykartavya/mykartavya/public/js/Activity_vol_Report/Ngo_page/ngo.vue?type=template
  var _withScopeId = (n) => (pushScopeId("data-v-2f2682a3"), n = n(), popScopeId(), n);
  var _hoisted_1 = { class: "container" };
  var _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h1", null, "NGO Page", -1));
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("div", _hoisted_1, [
      _hoisted_2,
      $setup.loading ? (openBlock(), createElementBlock("p", _hoisted_3, "Loading state information...")) : $setup.stateName ? (openBlock(), createElementBlock("p", _hoisted_4, [
        createTextVNode("Welcome to the NGO page for "),
        createBaseVNode("strong", null, toDisplayString($setup.stateName), 1),
        createTextVNode("!")
      ])) : (openBlock(), createElementBlock("p", _hoisted_5, "State not found")),
      createCommentVNode(" Add more content or components as needed ")
    ]);
  }

  // ../mykartavya/mykartavya/public/js/Activity_vol_Report/Ngo_page/ngo.vue
  ngo_default.render = render;
  ngo_default.__file = "../mykartavya/mykartavya/public/js/Activity_vol_Report/Ngo_page/ngo.vue";
  ngo_default.__scopeId = "data-v-2f2682a3";
  var ngo_default2 = ngo_default;

  // ../mykartavya/mykartavya/public/js/Activity_vol_Report/Ngo_page/ngo_page.bundle.js
  var Ngos = class {
    constructor({ wrapper }) {
    ...
    setup_app() {
      ...
      this.app = createApp(ngo_default2);
  ...
  frappe.ui.Ngos = Ngos;
  var ngo_page_bundle_default = Ngos;
})();
/*!
  * vue-router v4.5.1
...
* @license MIT
**/
//# sourceMappingURL=ngo_page.bundle.K2CASGF7.js.map
